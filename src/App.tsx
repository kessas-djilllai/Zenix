  ...
  return (
    <div dir={isRTL ? "rtl" : "ltr"} className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-blue-200 selection:text-blue-900 relative overflow-hidden transition-colors duration-300">
      ...
      <motion.div 
        ...
        className="absolute top-[-200px] left-[-100px] w-[600px] h-[600px] bg-blue-400 rounded-full blur-[100px] pointer-events-none"
      ></motion.div>
      <motion.div 
        animate={{ 
          scale: [1, 1.1, 1],
        ...
        className="absolute bottom-[-100px] right-[-100px] w-[400px] h-[400px] bg-indigo-400 rounded-full blur-[80px] pointer-events-none"
      ></motion.div>
